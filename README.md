Enterprise Hardware Catalog - Data Pipeline:
...
c. assignment_output.csv – Enriched dataset with financial metrics (Task 2)

d. taxonomy_output.csv – Product classification output (Task 3)
